...
const WalletPaymentConfirm = ({ userData, loadUserData, loadCartDataForHeader, orderUpdate }) => {
...
const amount = queryParams.get('amount');
  ...
  const loadData = () => {
    if (txId) {
      let apiUrl = `https://api-preprod.phonepe.com/apis/pg-sandbox/checkout/v2/order/${merchant_order_id}/status`;
      setIsLoading(true)
      API.get(apiUrl)
        .then(response => {
            ...
            {orderData && (
              ...
              <div className="account-part p-0">
                <div className='top-sec'>
                  ...
                  <p>Your Wallet Recharge order has been successfully placed.
                    <br />
