...
const OrderDriversPopup = ({ setterFunction, data, loadData, loadTableData,setTableData, orderConfirmPopup,confirmResource,setIsOrderModifyModalOpen }) => {
  ...
  const loadDriverData = () => {
    let apiUrl = `/delivery_person/?restaurant_user=${localStorage.getItem("userID")}&page_size=100&is_registration_completed=True`;
    if (ItemSearchInput) {
...
export default OrderDriversPopup;