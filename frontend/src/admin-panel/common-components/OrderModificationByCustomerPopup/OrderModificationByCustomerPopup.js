...
import './OrderModificationByCustomerPopup.scss'
import API from '../../../API';
...
const OrderModificationByCustomerPopup = ({ setterFunction, orderId, loadData, setTableData }) => {
  ...
  const updateOrderStatus = () => {
    ...
    API.put(`/order/orders/${data.id}/`, payLoad)
      .then(response => {
...
export default OrderModificationByCustomerPopup;