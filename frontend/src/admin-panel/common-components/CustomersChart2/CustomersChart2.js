    ...
    <g transform={`translate(${cx}, ${cy})`}>
      <defs>
        <radialGradient id="dotGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
          <stop offset="0%" style={{ stopColor: "#004938", stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: "#004938", stopOpacity: 0.8 }} />
        </radialGradient>
      </defs>
...
const CustomersSummary2 = ({source}) => {
  ...
  const loadData = () => {
    ...
    API.get(apiUrl)
      .then(response => {
        const { customer_count, orders, total_customers } = response.data;
  ...
  return (
    <div className="customer-summary-2">
          ...
          <ComposedChart data={data}
            ...
            <defs>
              <linearGradient id="colorOrders" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#004938" stopOpacity={0.8} />
                <stop offset="95%" stopColor="#004938" stopOpacity={0} />
              </linearGradient>
            </defs>
            ...
            <Tooltip />
            {/* <Legend /> */}
            <Area type="monotone" dataKey="customers" stroke="#004938" fillOpacity={1} strokeWidth={1} fill="url(#colorOrders)" dot={<CustomAnimatedDot />} />
...
export default CustomersSummary2;
