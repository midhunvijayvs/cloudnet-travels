...
import './DriverNewOrderPopup.scss'
import API from '../../../API';
...
const DriverNewOrderPopup = ({ setterFunction, updateItem }) => {
  ...
  return (
    <div className='custom-modal driver-new-order-popup'>
      <div className='card'>
        ...
        <div className='card-content'>
          <div className='w-100 d-flex justify-content-center mb-3'>
            <div className='green-circle'>
              <img className='cooking-icon' src='/images/icons/svg/driver.svg' />
            </div>
          </div>
...
export default DriverNewOrderPopup;