      ...
      <div className="chart">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            {/* <Line type="monotone" dataKey="orders" stroke="#ff7272" strokeWidth={2} dot={<CustomDot />} /> */}
          </ComposedChart>
        </ResponsiveContainer>
      </div>
...
export default OrdersChartAdmin;
