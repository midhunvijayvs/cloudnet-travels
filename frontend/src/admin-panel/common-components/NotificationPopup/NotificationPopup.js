...
const NotificationPopup = ({ setterFunction, notificationData, loadNotificationData }) => {
  ...
  return (
    <div className='admin-notification-popup' ref={popupRef} onMouseLeave={() => setterFunction(false)}>
      <ul className="notification-dropdown">
        ...
        {notificationData?.count > 20 &&
          <li className='button'
            onClick={() => { setterFunction(false); navigate('/admin/notification/list') }}
          >
