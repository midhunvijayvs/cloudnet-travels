...
import './GroceryOrderModificationByCustomerPopup.scss'
import API from '../../../API';
...
const GroceryOrderModificationByCustomerPopup = ({ setterFunction, orderId, loadData, setTableData }) => {
  ...
  const loadOrderData = () => {
    let apiUrl = `/grocery/orders/${orderId}/`;
    setIsLoading(true)
    API.get(apiUrl)
      .then(response => {
        setIsLoading(false)
  ...
  return (
    <div className='custom-modal order-customer-modification-popup'>
      {data &&
        <div className='card'>
          ...
          <div className='card-content'>
            ...
            <div className="sec-2">
              <div className="order-item-table table2 mt-3">
                          ...
                          {!item.final &&
                            (alternativeItemByRestaurant ?
                              <tr className={`alternative ${alternativeItemByRestaurant.final ? '' : 'rejected'}`}>
                                ...
                                <td className='text-start'>
                                  <div className='menu-item-name'>
                                    {alternativeItemByRestaurant.grocery_item_name}  {alternativeItemByRestaurant?.variant_details && `(${alternativeItemByRestaurant.variant_details})`}
                                    {/* <div>
                                ...
                                <td className='text-center'>
                                  <div className='d-flex justify-content-center'>
                                    ...
                                    >
                                      ...
                                      {alternativeItemByRestaurant.decision === "4" && "Rejected by Restaurant"}
                                    </div>
                          ...
                          {!item.final &&
                            (alternativeItemByCustomer &&
                              <tr className={`alternative ${alternativeItemByCustomer.final ? '' : 'rejected'}`}>
                                ...
                                <td className='text-start'>
                                  <div className='menu-item-name'>
                                    {alternativeItemByCustomer.grocery_item_name}  {alternativeItemByCustomer?.variant_details && `(${alternativeItemByCustomer.variant_details})`}
                                    {/* <div>
                                ...
                                <td className='status-column'>
                                  <div className='d-flex justify-content-center'>
                                    ...
                                    >
                                      ...
                                      {alternativeItemByCustomer.decision === "4" && "Rejected by Customer"}
                                    </div>
            ...
            {data?.is_user_modification_confirmed ?
              <div className='btns'>
              ...
              <div className="waiting-message">
                <div>The customer has modified the order. We are waiting for their payment confirmation.</div>
                <div>Once the payment is confirmed, you will be able to accept or reject the order.</div>
              </div>
            }
...
export default GroceryOrderModificationByCustomerPopup;