...
const Addresses = () => {
    ...
    return (
        <div className="admin-user-address">
            {data ?
                        ...
                        <div className="col-lg-12 address-section">
                            ...
                            {window.innerWidth < 992 &&
                                <div className="d-flex justify-content-end w-100 mb-3">
                                    <button className="btn theme-btn me-0 ms-auto" type="button" onClick={(e) => { setMode("add"); setIsEditModalOpen(true); setSelectedItem({ first_name: "", last_name: "", postcode: "", posttown: "" }) }}> Add New Address</button>
                                </div>
                            }
                                                ...
                                                <div className="address-body">
                                                    <div className="d-flex justify-content-start">
                                                        ...
                                                        <p className="normal-text">
                                                            {address.room_number && address.room_number}, {address.address_line1}<br />
                                                            {address.organisation}<br />
                                                            {address.premise},&nbsp;{address.street}<br />
                                                            {address.posttown},&nbsp;{address.postcode}<br />
                                                            {address.county},
                                                            UK
                                                        </p>
                                                    </div>
                                                    <div className="action-button-box">
                                                        ...
                                                        <button className="action-button" onClick={() => initiateEdit(address.id)}>
                        ...
                        <div className="col-lg-12 address-rhs">
                            {window.innerWidth > 992 &&
                                <div className="d-flex justify-content-center w-100 mb-3">
                                    <button className="btn theme-btn me-0" type="button" onClick={(e) => { setMode("add"); setIsEditModalOpen(true); setSelectedItem({ first_name: "", last_name: "", postcode: "", posttown: "" }) }}> Add New Address</button>
                                </div>
                            }
                                    ...
                                    <div className="address-item">
                                        ...
                                        <div className="address-body">
                                            <div className="d-flex justify-content-start">
                                                ...
                                                <p className="normal-text">
                                                    {primaryAddress.room_number && primaryAddress.room_number}, {primaryAddress.address_line1}<br />
                                                    {primaryAddress.organisation}<br />
                                                    {primaryAddress.premise},&nbsp;{primaryAddress.street}<br />
                                                    {primaryAddress.posttown},&nbsp;{primaryAddress.postcode}<br />
            ...
            {isEditModalOpen &&
                <AddressAddPopup setterFunction={setIsEditModalOpen} mode={mode} selectedId={selectedId} loadData={loadData} selectedItem={selectedItem} setSelectedItem={setSelectedItem}></AddressAddPopup>
            }
