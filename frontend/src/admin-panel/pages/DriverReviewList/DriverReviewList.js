...
const DriverReviewList = () => {
  ...
  return (
    <div className="admin-list-page driver-review-list-page">
                                          ...
                                          <div className="d-flex rating-box">
                                            <div className='star-box'>
                                              {[1, 2, 3, 4, 5].map((star) => (
                                                ...
                                                >
                                                  <path
                                                    className={item.driver_rating >= star ? "filled" : ""}
      ...
      {/* Review Modal */}
      {isReviewModalOpen &&
        <div className='custom-modal driver-review-modal'>
          <div className={`card`}>
            ...
            <div className='first-screen p-2'>
              ...
              <div className="w-100">
                ...
                <div className="item">
                  ...
                  <div className="instructions-br mb-2">
                    {selectedItem.driver_review ?
                      selectedItem.driver_review :
                      <div className="no-data">No Reviews</div>
                    }
                  </div>
                </div>
                <div className="item">
