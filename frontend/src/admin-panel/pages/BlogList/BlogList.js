...
const BlogList = () => {
  ...
  const loadTableData = () => {
    ...
    let apiUrl = `/communication/blogs/?page=${page}&page_size=${pageSize}`;
  ...
  const deleteItem = () => {
    API.delete(`/communication/blogs/${selectedItem.id}/`)
      .then(response => {
  ...
  return (
    <div className="admin-list-page blog-list-page">
                    ...
                    <div>
                      <div id="table_id_wrapper" className="dataTables_wrapper no-footer">
                        <div id="table_id_filter" className="dataTables_filter d-flex">
                          ...
                          <div className='filters'>
                            ...
                            {isFilterOpen && (
                              <div className='dropdown'>
                                ...
                                <select name="category" className={`form-select `} value={filters.category} onChange={handlePopupFilterChange} >
                          ...
                          <label>
                            <input type="text" className="" aria-controls="table_id" placeholder='Search for Blog'
                                    ...
                                    {item.is_published ?
                                      <div className="d-flex justify-content-center align-items-center">
                                        ...
                                        <span className="publish-date ms-1">
                                          {item.published_on && item.published_on.substring(0, 10)}
                                        </span>
                                      </div> :
      ...
      {isDetailModalOpen &&
        <div className='custom-modal msg-detail-modal'>
          <div className='card'>
            <div className='close' onClick={() => { setIsDetailModalOpen(false) }}>
