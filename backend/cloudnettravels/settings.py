"""
Django settings for cloudnettravels project.
...
SECRET_KEY = 'django-insecure-*7r(gf@be#xwslt=qfq#a)4el1b&7jpc(xq7+ntu#2pspzo7k*'
...
WSGI_APPLICATION = 'cloudnettravels.wsgi.application'
